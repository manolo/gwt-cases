package com.talkwheel.mobile.client.jsni.exp;
...
public abstract class GQueryOverlay implements ExportOverlay<GQuery> {
  ...
  @ExportPackage("gQuery")
  @Export("jsUtils")
  public static class GQueryUtils implements Exportable {
    
    public static GQuery $(Object o) {
      System.out.println("Dollar " + o);
      GQuery ret =  GQuery.$(o);
...
//    }
    ...
    public static native void afterCreate() /*-{
      ...
      var obj = $wnd.gQuery.jsUtils;
      var fnc = $wnd.gQuery.jsUtils.$;
      for(i in obj) fnc[i] = obj[i];
      fnc.jsQuery = $wnd.gQuery.jsQuery;
      fnc.fn = fnc.jsQuery.prototype;
