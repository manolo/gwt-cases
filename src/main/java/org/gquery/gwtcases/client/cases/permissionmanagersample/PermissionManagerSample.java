 ...
 * the License.
 */
package org.gquery.gwtcases.client.cases.permissionmanagersample;
...
import org.gquery.gwtcases.client.cases.permissionmanagersample.MemberDatabase.MemberInfo;
import org.gquery.gwtcases.client.cases.permissionmanagersample.MemberDatabase.Permission;
...
public class PermissionManagerSample implements EntryPoint {
  ...
  static class DetailledMemberCell extends AbstractCell<MemberInfo> {
    ...
    @Override
    public void render(Context context, MemberInfo value, SafeHtmlBuilder sb) {
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get().add(new Label("Others members"));
    RootPanel.get().add(createAllMemberList());

    RootPanel.get().add(new Label("Project members"));
    RootPanel.get().add(createPermissionTree());
